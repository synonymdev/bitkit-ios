...
struct SpendingConfirm: View {
    ...
    private func onConfirm() async throws {
        guard let confirmedFeeRate = satsPerVbyte, !transfer.isSpendingBusy else { return }
    ...
    private func calculateTransactionFee(address: String, amountSats: UInt64, feeRate: UInt32? = nil) async throws {
        do {
            ...
            if let feeRate {
                ...
                fastFeeRate = TransactionSpeed.fast.getFeeRate(from: feeEstimates)
            }
